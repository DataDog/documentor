...
licenses: # Runs go-licenses to check the licenses of the dependencies and generate a CSV file.
	$(GO) run github.com/google/go-licenses@latest report --template 'license.tpl' --ignore 'github.com/DataDog/documentor' 'github.com/DataDog/documentor' > LICENSE-3rdparty.csv
